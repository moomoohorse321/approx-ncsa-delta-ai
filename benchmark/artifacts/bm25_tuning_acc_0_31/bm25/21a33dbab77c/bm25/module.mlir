module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i16, dense<[16, 32]> : vector<2xi32>>, #dlti.dl_entry<i128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i8, dense<[8, 32]> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128", llvm.target_triple = "aarch64-unknown-linux-gnu", "polygeist.target-cpu" = "generic", "polygeist.target-features" = "+fp-armv8,+neon,+outline-atomics,+v8a,-fmv"} {
  ...
  func.func @lowering_corpus(%arg0: memref<?xmemref<?xi8>>, %arg1: memref<?xmemref<?xi8>>, %arg2: memref<?xi32>, %arg3: memref<?xf64>, %arg4: memref<?x!llvm.struct<(i32, f64)>>, %arg5: i32) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %4 = scf.index_switch %3 -> i32 
    case 0 {
      %5 = func.call @approx_lowering_corpus_3(%arg0, %arg1, %arg2, %arg3, %arg4, %arg5) : (memref<?xmemref<?xi8>>, memref<?xmemref<?xi8>>, memref<?xi32>, memref<?xf64>, memref<?x!llvm.struct<(i32, f64)>>, i32) -> i32
      scf.yield %5 : i32
    }
    case 1 {
      %5 = func.call @approx_lowering_corpus_3(%arg0, %arg1, %arg2, %arg3, %arg4, %arg5) : (memref<?xmemref<?xi8>>, memref<?xmemref<?xi8>>, memref<?xi32>, memref<?xf64>, memref<?x!llvm.struct<(i32, f64)>>, i32) -> i32
