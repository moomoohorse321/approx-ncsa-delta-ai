...
_KB_EVAL_QUESTIONS_IN_LOG_ORDER = ["where's the chick-fil-a kickoff game being played",
...
_KB_FIXED_EVAL_QUESTIONS_250 = _KB_EVAL_QUESTIONS_IN_LOG_ORDER[:_EVAL_SET_SIZE]
_KB_TUNING_POOL_350 = _KB_EVAL_QUESTIONS_IN_LOG_ORDER[_EVAL_SET_SIZE:]
_KB_TUNING_CHUNKS_25 = [
    _KB_TUNING_POOL_350[i:i + _TUNING_CHUNK_SIZE]
    for i in range(0, len(_KB_TUNING_POOL_350), _TUNING_CHUNK_SIZE)
]
_KB_TUNING_QUESTIONS_BY_SIZE = {
    size: _KB_TUNING_POOL_350[:size]
...
if __name__ == "__main__":
    ...
    if use_eval_slice:
        selected_questions = _KB_FIXED_EVAL_QUESTIONS_250
    else:
        ...
        selected_questions = _KB_TUNING_QUESTIONS_BY_SIZE[tuning_set_size]
