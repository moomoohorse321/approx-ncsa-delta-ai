...
from gemma.gm.iree.text import _sampling
from gemma.gm.iree.text import _tokenizer
...
class SamplerLoop:
  ...
  def _sample_step(
    ...
    # )
    # Match MLIR artifacts to model size.
    embed_dim = self.model.config.embed_dim
    if embed_dim == 1152:
      prefill_path = "gemma_1b_2048_prefill.mlir"
      decode_path = "gemma_1b_2048_decode.mlir"
    elif embed_dim == 2560:
